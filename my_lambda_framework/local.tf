locals {
 lambdas = {
   ...
   "script-1" = { lambda = {memory_size = "128M", description="description for 1", timeout = 30, runtime = "python3.8"}, cloudwatch ={retention_in_days = 14}, eventbridge ={enabled = true, schedule = "rate(5 minutes)", description="description for 1"}},
